...
workflow GatkConcordanceValidation {
    ...
    if (run_chromosomes){
        scatter(chr in chromosomes) {
            ...
            call PearsonCorrelationByAFNewImage as PearsonByAF_chr_new {
                input:
                    evalVcf = eval_vcf,
                    evalVcfIndex = eval_vcf_index,
                    af_resource = af_annotation_vcf,
    ...
    if (run_full_genome) {
        ...
        call PearsonCorrelationByAFNewImage as PearsonByAF_WholeGenome_new {
            input:
                evalVcf = eval_vcf,
                evalVcfIndex = eval_vcf_index,
                af_resource = af_annotation_vcf,
...
task PearsonCorrelationByAFNewImage {
    input {
        File evalVcf
        File evalVcfIndex
        File truthVcf
