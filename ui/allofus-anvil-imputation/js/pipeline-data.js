...
const PIPELINES = {
  array: {
    ...
    ancestryRows: [
      ...
      { count:  "13,226", label: "East Asian",            percent: "3%",   color: "#5CC88D" },
      { count:   "9,710", label: "South Asian",           percent: "2%",   color: "#80C6EC" },
      { count:   "1,065", label: "Middle Eastern",        percent: "0.2%", color: "#775FE5" },
      { count:  "44,627", label: "Remaining Individuals", percent: "9%",   color: "#ADB2BA" },
    ],
