...
public class TestUtils {
  ...
  public static final List<PipelineInputsDefinition> TEST_PIPELINE_INPUTS_DEFINITION_LIST =
      new ArrayList<>(
          List.of(
              new PipelineInputsDefinition(2L, "testRequiredStringInput", "String", true),
              new PipelineInputsDefinition(2L, "testOptionalStringInput", "String", false),
              new PipelineInputsDefinition(2L, "testRequiredIntInput", "Int", true),
              new PipelineInputsDefinition(2L, "testOptionalIntInput", "Int", false)));
