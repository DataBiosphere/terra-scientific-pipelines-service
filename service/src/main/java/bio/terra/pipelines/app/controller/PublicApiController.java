    ...
    if (docType.equals("termsOfService")) {
      response =
          """
              ...
              These Product Terms of Service (the “Product Terms”) supplement the Broad Clinical Laboratories Terms and Conditions of Service set forth above (the “Terms”) for your use of Data Science Services as operated by BCL. Any defined terms not defined herein carry the definition set forth in the Terms.\s
