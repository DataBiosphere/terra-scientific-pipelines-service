...
These Product Terms of Service (the "Product Terms") supplement the [Broad Clinical Laboratories Terms and Conditions of Service](<https://info.broadclinicallabs.org/hubfs/Terms/BCL Online T&C v 1.1 (2).pdf>) (the "Terms") for your use of Data Science Services as operated by BCL. Any defined terms not defined herein carry the definition set forth in the Terms.
