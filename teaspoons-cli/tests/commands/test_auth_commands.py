...
def test_login():
    ...
    with patch('teaspoons.commands.auth_commands.auth_logic.check_local_token_and_fetch_if_needed') as mock_check_local_token_and_fetch_if_needed:
...
def test_logout():
    runner = CliRunner()
    with patch('teaspoons.commands.auth_commands.auth_logic.clear_local_token') as mock_clear_local_token:
