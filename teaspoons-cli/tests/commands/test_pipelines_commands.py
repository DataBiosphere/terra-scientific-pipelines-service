...
def test_list_pipelines():
    ...
    with patch('teaspoons.commands.pipelines_commands.pipelines_logic.list_pipelines') as mock_list_pipelines:
...
def test_get_info_success():
    ...
    with patch('teaspoons.commands.pipelines_commands.pipelines_logic.get_pipeline_info') as mock_get_pipeline_info:
